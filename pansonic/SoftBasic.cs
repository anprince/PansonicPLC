...
namespace Pansonic
{
    ...
    class SoftBasic
    {
        ...
        #region TimeSpan Format   // 从一个时间差返回带单位的描述
        ...
        #region Array Expaned  //通用的数组新增个数方法
        ...
        #region Byte Array compare   //判断两个字节的指定部分是否相同
        ...
        #region Enum About   //获取一个枚举类型的所有枚举值，可直接应用于组合框数据
        ...
        #region JSON Data Get   // 一个泛型方法，提供json对象的数据读取
        ...
        ///// </example>
        //public static T GetValueFromJsonObject<T>(XObject json, string value_name, T default_value)
        //{
        ...
        #region Exception Message Format    // 显示一个完整的错误信息
...
//        }
        ...
        #region Hex string and Byte[] transform     //各类型数据转换
        ...
        #region Byte Reverse By Word     // 将byte数组按照双字节进行反转，如果为单数的情况，则自动补齐
        ...
        #region Byte[] and AsciiByte[] transform     // 将原始的byte数组转换成ascii格式的byte数组
        ...
        #region Bool[] and byte[] transform   // 将bool数组和byte数组转换
        ...
        ///// </remarks>
        //public static SystemVersion FrameworkVersion { get; set; } = new SystemVersion("6.0.4");
        ...
        #region   //汉字与16进制转换
        public static string ToHex(string s, string charset, bool fenge)   //从汉字转换到16进制
        {
            /// <summary>
            /// 
            /// </summary>
        ...
        public static string UnHex(string hex, string charset)  // 16进制转换成汉字
        {
        ...
        private static byte[] strToToHexByte(string hexString)  // 字符串转16进制字节数组
        {
